...
@Component("TeamEventEntity")
@Entity
public class TeamEventEntity implements Serializable, EntidadeBase {
	...
	public String toString() {
		return "TeamEventEntity [id=" + id + ", name=" + name + ", dateOfQuest=" + dateOfQuest + ", timeOfQuest="
				+ timeOfQuest + ", photo=" + photo + ", photo_name=" + photo_name + ", prize=" + prize + ", status="
				+ status + ", team=" + team + "]";
	}
