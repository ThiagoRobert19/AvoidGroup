...
@Component("UserAlbumEntity")
@Entity
public class UserAlbumEntity implements Serializable, EntidadeBase {
	...
	private String privacy;// private, public
	...
	public String toString() {
		return "UserAlbumEntity [id=" + id + ", uuid=" + uuid + ", image=" + image + ", photoName=" + photoName
				+ ", subtitle=" + subtitle + ", privacy=" + privacy + ", userEntity=" + userEntity
