...
<div class="product-feed-tab" id="info-dd">
	...
	<div class="usy-dt">
		...
		<div class="usy-name">
			<h3>
				<a href="<c:url value="/user/view/${teamEntity.owner.id}"/>"><c:out value="${teamEntity.owner.userName}" /></a>
			</h3>
			<spam>Owner</spam>
	...
	<c:if test="${not empty teamEntity.admin.id}">
		<div class="usy-dt">
			...
			<div class="usy-name">
				<h3>
					<a href="<c:url value="/user/view/${teamEntity.admin.id}"/>"><c:out value="${teamEntity.admin.userName}" /></a>
				</h3>
				<spam>Admin</spam>
