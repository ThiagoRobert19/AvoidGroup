				...
				<section class="wp wp-6">
					<div class="card card-social text-center">
						<div class="card-body has-gradient text-white">
							...
							<c:out value="${summaries.personaname}" />
							</h5>

							<div class="h6 text-muted">Creation: <c:out value="${summaries.timecreated}" />
								</div>
					...
					<div class="card">
						<div class="card-body">
							<div class="h7 text-muted">
								<a href="${summaries.profileurl}">
									Click Here to see at Steam:</a>
							</div>
							<div class="h7">Last time played: ${summaries.lastlogoff}</div>
						</div>
